...
type Quote = { id: string; number: string; type: string; status: string; company: string; project: string | null; revisions: { grandTotalPaise: number; eventDays?: number | null }[] };
