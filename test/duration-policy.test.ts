...
const policy = (mode: "ONE_OFF" | "USAGE_DAYS" | "MANUAL", roundingMode: "NONE" | "CEIL" | "FLOOR" | "HALF_UP" = "NONE") => ({ id: `${mode}-${roundingMode}`, code: `${mode}_${roundingMode}`, name: mode, mode, chargeMultiplierNumerator: mode === "USAGE_DAYS" ? 1 : 1, chargeMultiplierDenominator: mode === "USAGE_DAYS" ? 2 : 1, minimumChargeNumerator: mode === "USAGE_DAYS" ? 1 : 0, minimumChargeDenominator: 1, roundingMode, active: true });
